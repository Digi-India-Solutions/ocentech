        ...
        <>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6 mb-4 mb-md-0">
                           ...
                           <div className="SMStitle mb-3">
                                <h2 className=" ">
                                   <span className="titlebold "> Bulk SMS on Whatsapp  </span> Engage Customers on Their Favorite Messaging App
                                </h2>
                            </div>
            ...
            <div className="">
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-6 textCloumn">
                            ...
                            <div>
                            <h2 className=" mt-5 fontweight"> Send pdf,s Images , and Excel Attachment via <span className="titlebold">  Whatsapp bulk SMS Services</span> "</h2>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 textCloumn">
                            ...
                            <div>
                             <h2 className="mb-5 fontweight">What is <span className="titlebold"> Bulk SMS</span> on  <span className="titlebold">WhatsApp </span> and Its Benefits"	</h2>
                ...
                <div className="container">
                    ...
                    <div className="row">
                                <h2 className="fontweight"> How  <span className="titlebold">Bulk SMS Marketing </span> on WhatsApp Works"</h2>
                        <div className="col-md-6 textCloumn">
