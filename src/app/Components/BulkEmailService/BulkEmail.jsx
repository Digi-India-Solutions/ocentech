                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6 mb-4 mb-md-0">
                           ...
                           <div className="SMStitle mb-3">
                                <h2 className="">
                                    <span className="text-left titlebold"> Bulk Email Marketing </span> Reach Thousands with a Single Click
                                </h2>
                            </div>
                        ...
                        <div className="col-md-6 textCloumn">
                            ...
                            <div>
                                <div className=" Whats-app-title text-center">
                                    <h2 className=" mt-5 text-start "> Launch a Professional  <span className="titlebold"> Bulk Email Campaign    </span>in Minutes"
                                    </h2>
                                </div>
                                <p>
                                    We provide an easy to use bulk email marketing platform that helps you launch professional marketing campaigns. Select predefined templates, add your message and your campaign is ready to go LIVE. <br/>
                                <b> Use email marketing to send: </b> <br />
                                    Newsletters <br />
                                    Latest / popular blogs <br />
                                    Promote products services <br />
                                    Share your brands story <br />
                                    Nature leads								</p>
                            </div>

                        </div>
                        <div className="col-md-6">
                            <Image src={Pic1} alt="whatsappimg1" className="whatsappImg1 Pic1" />
                        </div>
                    </div>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 d-flex align-items-center">
                            <Image src={Pic2} alt="whatsappimg2" className="whatsappImg2 Pic1" />
                        </div>
                        <div className="col-md-6 textCloumn">

                            <div >
                            <h2 className="text-start" >Our  <span className="titlebold"> Email Marketing Services   </span>and What We Offer"
                            </h2>
                                <p>
