          ...
          <div className="col-md-6 mb-4 mb-md-0">
            ...
            <div className="SMS-Content" >
              <p className="text-muted mb-4">
               ...
               <Link href="/Pages/contact"> <button className="btn btn-primary ">Schedule Demo</button></Link>
            </div>
          </div>
...
//                 high-delivery SMS gateway.
//               </p>
//               <button className="btn themebacground text-light px-4"> <Link href="/Pages/contact"> <button className="btn btn-primary ">Schedule Demo</button></Link></button>
//             </div>
//           </div>
