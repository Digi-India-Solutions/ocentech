                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 textCloumn">
                            ...
                            <div>
                                <div className=" RCS-title text-center">
                                    <h2 className=" mt-5  text-start"> <span className="titlebold"> Rich Communication Services  (RCS) </span>   The Future of Messaging
                                    </h2>
                                </div>
                                <p>
                        ...
                        <div className="col-md-6">
                            <Image src={Pic1} alt="whatsappimg" className="RCSImg1 Pic1" />
                        </div>
                    </div>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 d-flex align-items-center">
                            <Image src={Pic2} alt="whatsappimg" className="RCSImg2 Pic1" />
                        </div>
                        <div className="col-md-6 textCloumn">

                            <div>

                                <h2> RCS <span className="titlebold">(Rich Communication Services),</span>
