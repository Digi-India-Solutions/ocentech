...
export default function IVRService() {
    ...
    return (
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6 mb-4 mb-md-0">
                            ...
                            <div className="SMStitle mb-3">
                                <h2 className=" fontweight text-align-start">
                                 <span className="spanbold">   IVR Services </span> Automate Customer Calls with Interactive Voice Response
                                </h2>
                            </div>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 textCloumn">
                            ...
                            <div>
                                <div className=" IVR-title text-left">
                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 textCloumn">
                            ...
                            <div>
                            <h2>Top Key Features of IVR <span className="titlebold"> (Interactive Voice Response) </span> Systems	</h2>
                                <p>
      ...
      <h2 className="title">  <span className="titlebold">IVR Services </span>Provide in India </h2>
