                        ...
                        <div className="col-md-6 textCloumn">
                            ...
                            <div>
                                <div className=" Whats-app-title text-center">
                                    <h2 className=" mt-5  fontweight text-start">    High-Performance <span className="titlebold"> Bulk SMS Marketing Services </span> to Grow Your Business
                                    </h2>
                                </div>
                                <p>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 textCloumn">
                            ...
                            <div>
                            <h2 className=" fontweight">     Seamlessly Integrate <span className="titlebold ">Bulk SMS</span> with <span className="titlebold">Email , Whatsapp</span> and Other <span className="titlebold">Marketing</span>  Channels	
                            </h2>
                                <p>
                                ...
                                <h2 className=" fontweight">  Run <span className="titlebold uppercase"> Targeted SMS Marketing Campaigns </span> with Exceptional Open Rates	</h2>
