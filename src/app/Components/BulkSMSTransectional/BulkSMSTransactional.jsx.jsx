                        ...
                        <div className="col-md-6 textCloumn">
                            ...
                            <div>
                                <div className=" Whats-app-title text-center">
                                    <h2 className=" mt-5 uppercase fontweight text-start "> <span className="titlebold">Transactional SMS: </span>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 textCloumn">
                            ...
                            <div>
                                <h2 className="fontweight uppercase">     Top Benefits of <span className="titlebold"> Bulk SMS Marketing</span> for<span className="titlebold"> Business Growth</span>
                                </h2>
