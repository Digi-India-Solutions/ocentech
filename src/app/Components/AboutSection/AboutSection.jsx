                        ...
                        <div className="col-md-6">
                            <div>     
                                <div className="aboutSecTitle">
                                    ...
                                    <h2 className='text-right fontweight ps-4'>Delivering <span className='titlebold'>Innovation and Strategic Business  </span> Solutions for Growth and Success"</h2>
                                </div>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className='aboutbottomSec'>
                               ...
                               <h2 className=' w-75 fontweight mb-3'>	Why Choose Us for Your <span className='titlebold'>Trusted  Business</span> Growth Partner </h2>
                        ...
                        <div className="col-md-6">
                            ...
                            <div className=' d-flex text-start'>
                                ...
                                <h2 className='fontweight w-75 ps-4  mb-3'>   Our Vision Shaping the Future with <span className='titlebold'>Innovation and Excellence	</span>	</h2>
                         </div>
                                <p className='paragraph-details'>
